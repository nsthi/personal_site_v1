...
//Lets load the scripts
        ...
        function c3m_coda_scripts() {
                 wp_enqueue_script('coda_slider', get_bloginfo('template_url') . '/wp-coda-slider/js/coda.slider.js', array('jquery'));
//enqueue style sheet
                wp_enqueue_style('coda_slider', get_bloginfo('template_url') . '/wp-coda-slider/css/coda-slider-2.0.1.css');
  	}
                ...
                foreach($posts as $post){
                        ...
                        '<div class="panel" id="post-' . $post->ID . '">
                                <div class="panel-wrapper">
                                        ...
                                        ' . $post->post_content . ' <!-- post_coments -->
                                </div> <!-- .panel-wrapper -->
                        </div><!-- .panel #post-$id -->';
                }
