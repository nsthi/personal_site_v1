...
class OT_Admin
{
  ...
  function option_tree_admin() 
  {
    ...
    {
      // create menu item
      $option_tree_options = add_submenu_page( 'themes.php', 'Big City Theme Options','Theme Options', 'activate_plugins', 'option_tree', array( $this, 'option_tree_options_page' ) );
    ...
    else
    {
      ...
      // create menu items
      add_object_page( 'Big City', 'Big City', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ), $icon);
      $option_tree_options = add_submenu_page( 'option_tree', 'Big City', 'Theme Options', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ) );
      $option_tree_docs = add_submenu_page( 'option_tree', 'Big City', 'Documentation', 'manage_options', 'option_tree_docs', array( $this, 'option_tree_docs_page' ) );
      $option_tree_settings = add_submenu_page( 'option_tree', 'Big City', 'Settings', 'manage_options', 'option_tree_settings', array( $this, 'option_tree_settings_page' ) );
