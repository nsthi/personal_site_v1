<?php
	...
	function su_plugin_init() {
		...
		add_shortcode( su_compatibility_mode_prefix() . 'divider2', 'su_divider2_shortcode' );
		add_shortcode( su_compatibility_mode_prefix() . 'divider3', 'su_divider3_shortcode' );
		...
		add_shortcode( su_compatibility_mode_prefix() . 'featured_posts', 'featured_posts_shortcode' );
		add_shortcode( su_compatibility_mode_prefix() . 'featured_posts2', 'featured_posts_shortcode2' );
		add_shortcode( su_compatibility_mode_prefix() . 'featured_posts3', 'featured_posts_shortcode3' );
	...
	function su_manage_settings() {
		...
		// Save main settings
		if ( isset( $_POST['save'] ) && isset($_GET['page']) && $_GET['page'] == 'shortcodes-ultimate' ) {
