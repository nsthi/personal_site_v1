...
define('GRUNION_PLUGIN_DIR', TEMPLATEPATH . '/grunion-contact-form');
define('GRUNION_PLUGIN_URL', get_template_directory_uri() . '/grunion-contact-form');
...
$contact_successmsg = get_option_tree('contact_successmsg');
$contact_required = get_option_tree('contact_required');
...
function contact_form_shortcode( $atts, $content ) {
	...
	$contact_submit = get_option_tree ('contact_submit', '');
	$r .= "<form action='' method='post' class='contact-form commentsblock'>\n";
	$r .= $body;
	$r .= "\t<p class='contact-submit'>\n";
	if($contact_submit){
	$r .= "\t\t<input type='submit' value='" . __( $contact_submit) . "' class='ka-form-submit'/>\n";}
	else{
	$r .= "\t\t<input type='submit' value='" . __( "Submit" ) . "' class='ka-form-submit'/>\n";}
	$r .= "\t\t$nonce\n";
...
function contact_form_init() {
	...
	register_post_type( 'feedback', array(
		'labels'	=> array(
			...
			'not_found_in_trash'	=> __( 'No message found' )
		),
