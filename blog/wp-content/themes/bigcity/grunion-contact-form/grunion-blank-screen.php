...
<div class="fb-default-container">
	...
	<p>Once a reader submits feedback through your contact form it is first checked by Akismet for spam. If it's legitimate, you'll receive an email containing the feedback.  If Akismet flags it as spam, it will go straight to your spam folder (and no email will be sent to you).  You can then view all of your feedback by clicking the Messages link.</p>
</div>
