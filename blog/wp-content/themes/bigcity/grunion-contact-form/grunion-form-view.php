...
<body>
	...
	<div class="fb-right">
		<div id="fb-desc" class="fb-desc">
			...
			<h3 style="margin-top: 21px;">Can I view my messages within WordPress?</h3>
			<p>Yep, you can read your messages at any time by clicking the "<a id="fb-feedback" href="<?php echo admin_url( 'edit.php?post_type=feedback' ); ?>">Messages</a>" link in the main admin menu.</p>
			<div class="clear"></div>
		</div>
	...
	<form id="fb-preview">
		<div id="fb-preview-form" class="fb-container">
			...
			<input type="submit" class="button-primary" tabindex="4" value="Insert this form" id="fb-save-form" name="save">
		</div>
