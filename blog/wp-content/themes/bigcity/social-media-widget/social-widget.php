<?php
/**
 * Plugin Name: BIG CITY - Social Media Widget
...
if ( !defined('WP_CONTENT_URL') ) {
	define('SMW_PLUGINPATH', get_bloginfo('template_url') . '/social-media-widget/');
	define('SMW_PLUGINDIR', TEMPLATEPATH . '/social-media-widget/');
} else {
	define('SMW_PLUGINPATH', get_bloginfo('template_url') . '/social-media-widget/');
	define('SMW_PLUGINDIR', TEMPLATEPATH . '/social-media-widget/');
...
class Social_Widget extends WP_Widget {
	...
	function Social_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'social-widget', __('BIG CITY - Social Media', 'smw'), $widget_ops, $control_ops );
	}
	...
	<p><em>If you selected "Custom Icon Pack" from the beginning of this form, input the URL and path to those icons in the following boxes.</em><br />
	</p>
	...
	<!-- Custom Icon Pack Path: Text Input -->
		...
		<p><em>How can I use my own custom icon pack? <br />

1. Create a folder on the filesystem that is publicly accessible via the interwebs. I suggest putting it in your wp-content folder and name it 'icons'.<br />
2. Upload your icons into that folder. It'll probably be a good idea if they are all the same size.<br />
3. Go to the Widget Control Panel (Admin -> Appearance -> Widgets).<br />
4. Select "Custom Icons" as the Icon Pack.<br />
5. Enter the URL to the icon pack folder (http://www.yoursite.com/blog/wp-content/icons).<br />
6. Enter the FULL PATH to the icon pack folder (/var/www/html/yoursite/blog/wp-content/icons).<br />
7. Click Save.<br /></em></p>
