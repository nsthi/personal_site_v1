...
<?php if (function_exists('rps_show'))   
$total_posts = get_option('rps_total_posts');  
if ( empty($total_posts) )   
{  
	echo '<div id="post_error">Please go to Appearance > Post Slider in your admin panel and enter values for "Height" and "Total Posts"</div>';  
}  
else {  
	echo rps_show();  
}  
